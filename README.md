...
Como desafio principal do projeto solicitado pela vinheria Agnello foi o desenvolvimento de uma solução online que venha a reproduzir a experiência personalizada para cada cliente, considerando que a grande maioria de clientes possuem pouco conhecimento sobre os vinho e dependem da orientação de profissionais para realizar a escolha perfeita de vinho.
